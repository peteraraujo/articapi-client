...
/**
 * A digital publication section on the website.
 *
 ...
 * @property copy The text of the section.
 * @property authorDisplay A display-friendly text of the authors of this section.
 * @property digitalPublicationId Unique identifier of the digital publication this section belongs to.
 */
@Serializable
data class DigitalPublicationSection(
    @SerialName("id")
    val id: Int? = null,
    @SerialName("title")
    ...
    @SerialName("author_display")
    val authorDisplay: String? = null,
    @SerialName("digital_publication_id")
    val digitalPublicationId: Int? = null,
