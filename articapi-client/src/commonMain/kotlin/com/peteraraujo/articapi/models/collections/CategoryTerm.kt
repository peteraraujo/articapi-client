 ...
 * @property subtype Takes one of the following values: classification, material, technique, style, subject, department, theme.
 * @property parentId Unique identifier of this category's parent.
