 ...
 * @property iiifUrl IIIF URL of this image.
 * @property width Native width of the image.
 * @property height Native height of the image.
 * @property lqip Low-quality image placeholder (LQIP). Currently a 5x5-constrained, base64-encoded GIF.
 * @property colorfulness Unbounded positive float representing an abstract measure of colorfulness.
 * @property color Dominant color of this image in HSL.
 * @property phash Image hash generated using phash algorithm with 64 boolean subfields.
 * @property ahash Image hash generated using phash algorithm with 64 boolean subfields.
 * @property fingerprint Image hashes: aHash, dHash, pHash, wHash.
...
data class Image(
    ...
    @SerialName("lake_guid") val lakeGuid: String? = null,
    ...
    @SerialName("is_multimedia_resource") val isMultimediaResource: Boolean? = null,

    @SerialName("is_educational_resource") val isEducationalResource: Boolean? = null,

    @SerialName("is_teacher_resource") val isTeacherResource: Boolean? = null,

    @SerialName("credit_line") val creditLine: String? = null,

    @SerialName("content_e_tag") val contentETag: String? = null,
    ...
    @SerialName("lqip") val lqip: String? = null,

    @SerialName("colorfulness") val colorfulness: Double? = null,

    @SerialName("color") val color: Color? = null,

    @SerialName("ahash") val ahash: Hash? = null,

    @SerialName("phash") val phash: Hash? = null,

    @SerialName("fingerprint") val fingerprint: Fingerprint? = null,

    @SerialName("artwork_ids") val artworkIds: List<Int>? = null,

    @SerialName("artwork_titles") val artworkTitles: List<String>? = null,
    ...
    @SerialName("suggest_autocomplete_boosted") val suggestAutocompleteBoosted: String? = null,
